...
CASES = [
    ...
    {
        "id": "hiperestatica", "module": "statics",
        "name": "Empotrada-apoyada (hiperestatica)",
        "note": "El equilibrio deja una incognita: la cierran las mismas condiciones de desplazamiento del isostatico.",
        "model": model("Empotrada-apoyada",
                       [force("q1", "Carga uniforme", FULL, {"type": "uniform", "w": "w0"})],
    ...
    {
        "id": "continua", "module": "statics",
        "name": "Viga continua sobre tres apoyos",
        "note": "Dos vanos iguales: el apoyo central se lleva 5/8 de la carga total.",
        "model": model("Viga continua",
                       [force("q1", "Carga uniforme", FULL, {"type": "uniform", "w": "w0"})],
